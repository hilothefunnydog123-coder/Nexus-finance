...
vrTrend  = input.float(1.4, "VR ≥ x ⇒ TRENDING (take breakouts)", step=0.05, group="① Regime Gate")
...
extAtr    = input.float(0.5,  "Extend past channel (ATR ×)", step=0.05, group="② Breakout", tooltip="Price must push this far BEYOND the channel before entering — filters out false pokes that instantly reverse. The single biggest profit-factor lever (out-of-sample validated at 0.5).")
// ═══════════ ③ STOP / TARGET ═══════════
