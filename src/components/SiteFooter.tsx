...
const COLS: [string, [string, string][]][] = [
  ['Product', [['YnKalshi', '/edge'], ['The Arena', '/arena'], ['AI Stock Analyzer', '/ai-stocks'], ['Stock Forecasts', '/stock'], ['Compare Stocks', '/compare'], ['Courses', '/courses'], ['Algorithms', '/algorithms'], ['AI Track Record', '/performance'], ['Intelligence Suite', '/intelligence'], ['Agent Network', '/agents']]],
