    ...
    <div style={{ background: PANEL, border: `1px solid ${BORDER}`, borderRadius: 8, padding: 'clamp(12px,2vw,18px)', display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
        <input
          ...
          style={{ flex: '1 1 240px', minWidth: 0, background: VOID, border: `1px solid ${BORDER}`, borderRadius: 6, color: TXT, fontSize: 13, padding: '9px 12px', outline: 'none', fontFamily: 'inherit' }}
        />
